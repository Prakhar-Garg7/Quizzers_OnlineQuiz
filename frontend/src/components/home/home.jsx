        ...
        <div className="mx-auto w-full max-w-7xl">
            ...
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                <div className="relative z-10 max-w-screen-xl px-4 pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl space-y-8 text-center sm:text-right sm:ml-auto">
                        <h2 className="text-4xl font-bold sm:text-5xl">
                            Welcome to Quizzers
                            <span className="hidden sm:block text-4xl">Your Ultimate Quiz Platform</span>
                        </h2>
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full">
                    <img className="w-96" src="https://media.istockphoto.com/id/1356323195/photo/quiz-word-sitting-next-to-a-white-alarm-clock-on-blue-background.jpg?s=612x612&w=0&k=20&c=mrFwb4WRTUDq1EQLfyUMmyRX30LW49bahlkEvOf84j4=" alt="image1" />
                </div>
            </aside>

            {/* Image Section */}
            <div className="grid place-items-center sm:mt-20">
                <img className="sm:w-96 w-48" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfR6jYXjVm9JQxs3YVk7LzmxOdy3omQgJqcg&s" alt="image2" />
            </div>
            ...
            <div className="grid sm:grid-cols-3 grid-cols-1 gap-6 px-4 py-12 text-center">
